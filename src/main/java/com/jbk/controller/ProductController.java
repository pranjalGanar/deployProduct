...
public class ProductController {
	...
	@PostMapping(value="/export-Sheet")
	public ResponseEntity<String> exportProductsToExcel(HttpServletResponse response){
		//System.out.println(myFile.getOriginalFilename());
		String home=System.getProperty("user.home");
		
		String msg=service.exportProductsToExcel(home+"/Downloads/ExportedProducts.Xlsx");
		return  new ResponseEntity<String>(msg,HttpStatus.OK);
	}
	
	@PostMapping(value="/uploadSheet")
	public ResponseEntity<Map<String,Object>> uploadSheet(@RequestParam CommonsMultipartFile file,HttpSession session ){
